...
public abstract class CommandManager extends AbstractManager {
	...
	public void takeOff() {
		//sendCommand("AT*REF=" + SEQ +",290717952");
	...
	public void stop() {
		//изменила второй бит на 0!!!
		command = "AT*PCMD=" + SEQ + ",0,0,0,0,0";
		continuance = true;
	}
	...
	public void run() {
		initializeDrone();
		//sendCommand("AT*CONFIG=605," + "control:outdoor" + "TRUE") ;
		while (true) {
			//sendCommand("AT*CALIB=" + SEQ + ",290717952" );
			if (this.command != null) {
				...
				if (landing) {
					//изменила второй бит с 1 на 0!!!
					sendCommand("AT*PCMD=" + SEQ + ",0,0,0,0,0" + CR
